...
const EditCourse: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.patch(`/courses/${courseId}/edit/`, {
        title: formData.title,
        description: formData.description,
        requirements: formData.requirements,
      });

      // Update/create sections and chapters
      for (let sectionIndex = 0; sectionIndex < sections.length; sectionIndex++) {
        ...
        if (section.title.trim()) {
          ...
          if (sectionId) {
            ...
            await api.patch(`/courses/sections/${sectionId}/edit/`, {
              title: section.title,
          ...
          for (let chapterIndex = 0; chapterIndex < section.chapters.length; chapterIndex++) {
            ...
            if (chapter.title.trim()) {
              if (chapter.id) {
                ...
                await api.patch(`/courses/chapters/${chapter.id}/edit/`, {
                  title: chapter.title,
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-base text-gray-600">
            Update course details, sections, and chapters
          </p>
        </div>
